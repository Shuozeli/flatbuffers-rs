...
impl<'a> RustGenerator<'a> {
    ...
    fn gen_header(&mut self) {
        self.w.line("// automatically generated by flatc-rs, do not modify");
    ...
    fn gen_root_type_functions(&mut self) {
        ...
        if let Some(ref ident) = self.schema.file_ident {
            if !ident.is_empty() {
                self.w
                    .line(&format!("pub const {upper_snake}_IDENTIFIER: &str = \"{ident}\";"));
                self.w.blank();
            }
        }
        ...
        self.w.indent();
        self.w.line(&format!("::flatbuffers::root::<{full_name}>(buf)"));
        self.w.dedent();
        self.w.line("}");
        self.w.blank();
        ...
        self.w.indent();
        self.w
            .line(&format!("::flatbuffers::size_prefixed_root::<{full_name}>(buf)"));
        self.w.dedent();
        self.w.line("}");
        self.w.blank();
