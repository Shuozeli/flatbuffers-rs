...
pub mod optional_scalars {
  ...
  impl<'a> ScalarStuff<'a> {
    ...
    pub fn just_i8(&self) -> i8 {
      unsafe { self._tab.get::<i8>(Self::VT_JUST_I8, Some(0)).unwrap() }
    }

    #[inline]
    pub fn maybe_i8(&self) -> Option<i8> {
      unsafe { self._tab.get::<i8>(Self::VT_MAYBE_I8, None) }
    }

    #[inline]
    pub fn default_i8(&self) -> i8 {
      unsafe { self._tab.get::<i8>(Self::VT_DEFAULT_I8, Some(42)).unwrap() }
    }

    #[inline]
    pub fn just_u8(&self) -> u8 {
      unsafe { self._tab.get::<u8>(Self::VT_JUST_U8, Some(0)).unwrap() }
    }

    #[inline]
    pub fn maybe_u8(&self) -> Option<u8> {
      unsafe { self._tab.get::<u8>(Self::VT_MAYBE_U8, None) }
    }

    #[inline]
    pub fn default_u8(&self) -> u8 {
      unsafe { self._tab.get::<u8>(Self::VT_DEFAULT_U8, Some(42)).unwrap() }
    }

    #[inline]
    pub fn just_i16(&self) -> i16 {
      unsafe { self._tab.get::<i16>(Self::VT_JUST_I16, Some(0)).unwrap() }
    }

    #[inline]
    pub fn maybe_i16(&self) -> Option<i16> {
      unsafe { self._tab.get::<i16>(Self::VT_MAYBE_I16, None) }
    }

    #[inline]
    pub fn default_i16(&self) -> i16 {
      unsafe { self._tab.get::<i16>(Self::VT_DEFAULT_I16, Some(42)).unwrap() }
    }

    #[inline]
    pub fn just_u16(&self) -> u16 {
      unsafe { self._tab.get::<u16>(Self::VT_JUST_U16, Some(0)).unwrap() }
    }

    #[inline]
    pub fn maybe_u16(&self) -> Option<u16> {
      unsafe { self._tab.get::<u16>(Self::VT_MAYBE_U16, None) }
    }

    #[inline]
    pub fn default_u16(&self) -> u16 {
      unsafe { self._tab.get::<u16>(Self::VT_DEFAULT_U16, Some(42)).unwrap() }
    }

    #[inline]
    pub fn just_i32(&self) -> i32 {
      unsafe { self._tab.get::<i32>(Self::VT_JUST_I32, Some(0)).unwrap() }
    }

    #[inline]
    pub fn maybe_i32(&self) -> Option<i32> {
      unsafe { self._tab.get::<i32>(Self::VT_MAYBE_I32, None) }
    }

    #[inline]
    pub fn default_i32(&self) -> i32 {
      unsafe { self._tab.get::<i32>(Self::VT_DEFAULT_I32, Some(42)).unwrap() }
    }

    #[inline]
    pub fn just_u32(&self) -> u32 {
      unsafe { self._tab.get::<u32>(Self::VT_JUST_U32, Some(0)).unwrap() }
    }

    #[inline]
    pub fn maybe_u32(&self) -> Option<u32> {
      unsafe { self._tab.get::<u32>(Self::VT_MAYBE_U32, None) }
    }

    #[inline]
    pub fn default_u32(&self) -> u32 {
      unsafe { self._tab.get::<u32>(Self::VT_DEFAULT_U32, Some(42)).unwrap() }
    }

    #[inline]
    pub fn just_i64(&self) -> i64 {
      unsafe { self._tab.get::<i64>(Self::VT_JUST_I64, Some(0)).unwrap() }
    }

    #[inline]
    pub fn maybe_i64(&self) -> Option<i64> {
      unsafe { self._tab.get::<i64>(Self::VT_MAYBE_I64, None) }
    }

    #[inline]
    pub fn default_i64(&self) -> i64 {
      unsafe { self._tab.get::<i64>(Self::VT_DEFAULT_I64, Some(42)).unwrap() }
    }

    #[inline]
    pub fn just_u64(&self) -> u64 {
      unsafe { self._tab.get::<u64>(Self::VT_JUST_U64, Some(0)).unwrap() }
    }

    #[inline]
    pub fn maybe_u64(&self) -> Option<u64> {
      unsafe { self._tab.get::<u64>(Self::VT_MAYBE_U64, None) }
    }

    #[inline]
    pub fn default_u64(&self) -> u64 {
      unsafe { self._tab.get::<u64>(Self::VT_DEFAULT_U64, Some(42)).unwrap() }
    }

    #[inline]
    pub fn just_f32(&self) -> f32 {
      unsafe { self._tab.get::<f32>(Self::VT_JUST_F32, Some(0.0_f32)).unwrap() }
    }

    #[inline]
    pub fn maybe_f32(&self) -> Option<f32> {
      unsafe { self._tab.get::<f32>(Self::VT_MAYBE_F32, None) }
    }

    #[inline]
    pub fn default_f32(&self) -> f32 {
      unsafe { self._tab.get::<f32>(Self::VT_DEFAULT_F32, Some(0.0_f32)).unwrap() }
    }

    #[inline]
    pub fn just_f64(&self) -> f64 {
      unsafe { self._tab.get::<f64>(Self::VT_JUST_F64, Some(0.0_f64)).unwrap() }
    }

    #[inline]
    pub fn maybe_f64(&self) -> Option<f64> {
      unsafe { self._tab.get::<f64>(Self::VT_MAYBE_F64, None) }
    }

    #[inline]
    pub fn default_f64(&self) -> f64 {
      unsafe { self._tab.get::<f64>(Self::VT_DEFAULT_F64, Some(0.0_f64)).unwrap() }
    }

    #[inline]
    pub fn just_bool(&self) -> bool {
      unsafe { self._tab.get::<bool>(Self::VT_JUST_BOOL, Some(false)).unwrap() }
    }

    #[inline]
    pub fn maybe_bool(&self) -> Option<bool> {
      unsafe { self._tab.get::<bool>(Self::VT_MAYBE_BOOL, None) }
    }

    #[inline]
    pub fn default_bool(&self) -> bool {
      unsafe { self._tab.get::<bool>(Self::VT_DEFAULT_BOOL, Some(true)).unwrap() }
    }

    #[inline]
    pub fn just_enum(&self) -> OptionalByte {
      unsafe { self._tab.get::<OptionalByte>(Self::VT_JUST_ENUM, Some(OptionalByte(0))).unwrap() }
    }

    #[inline]
    pub fn maybe_enum(&self) -> Option<OptionalByte> {
      unsafe { self._tab.get::<OptionalByte>(Self::VT_MAYBE_ENUM, None) }
    }

    #[inline]
    pub fn default_enum(&self) -> OptionalByte {
      unsafe { self._tab.get::<OptionalByte>(Self::VT_DEFAULT_ENUM, Some(OptionalByte::One)).unwrap() }
    }
  }
  ...
  impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ScalarStuffBuilder<'a, 'b, A> {
    ...
    pub fn add_just_f32(&mut self, just_f32: f32) {
      self.fbb_.push_slot::<f32>(ScalarStuff::VT_JUST_F32, just_f32, 0.0_f32);
    }
    ...
    pub fn add_default_f32(&mut self, default_f32: f32) {
      self.fbb_.push_slot::<f32>(ScalarStuff::VT_DEFAULT_F32, default_f32, 0.0_f32);
    }

    #[inline]
    pub fn add_just_f64(&mut self, just_f64: f64) {
      self.fbb_.push_slot::<f64>(ScalarStuff::VT_JUST_F64, just_f64, 0.0_f64);
    }
    ...
    pub fn add_default_f64(&mut self, default_f64: f64) {
      self.fbb_.push_slot::<f64>(ScalarStuff::VT_DEFAULT_F64, default_f64, 0.0_f64);
    }
    ...
    pub fn add_just_enum(&mut self, just_enum: OptionalByte) {
      self.fbb_.push_slot::<OptionalByte>(ScalarStuff::VT_JUST_ENUM, just_enum, OptionalByte(0));
    }
    ...
    #[inline]
    pub fn new(fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> ScalarStuffBuilder<'a, 'b, A> {
      let start = fbb.start_table();
      ScalarStuffBuilder { fbb_: fbb, start_: start }
    }
  ...
  #[inline]
  pub fn createScalarStuff<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
  ...
  impl ScalarStuffT {
    ...
    _fbb: &mut ::flatbuffers::FlatBufferBuilder<'b, A>,
      ...
      createScalarStuff(_fbb, &ScalarStuffArgs {
        just_i8,
        maybe_i8,
        default_i8,
        just_u8,
