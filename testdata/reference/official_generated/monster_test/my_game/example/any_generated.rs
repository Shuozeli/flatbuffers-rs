...
impl AnyT {
    ...
    pub fn take_test_simple_table_with_enum(
        &mut self,
    ) -> Option<alloc::boxed::Box<TestSimpleTableWithEnumT>> {
    ...
    pub fn take_my_game_example_2_monster(
        &mut self,
    ) -> Option<alloc::boxed::Box<super::example_2::MonsterT>> {
