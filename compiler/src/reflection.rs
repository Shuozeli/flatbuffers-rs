//! Auto-generated FlatBuffers reflection reader types.
//!
//! **DO NOT EDIT THIS FILE MANUALLY.** It was generated by the C++ `flatc`
//! compiler from `reflection.fbs` (the official FlatBuffers reflection schema)
//! and copied from `original-flatc/rust/reflection/src/reflection_generated.rs`.
//!
//! These types are used by [`crate::bfbs::deserialize_schema`] to read `.bfbs`
//! binary schema files. Each type (Schema, Object, Field, Enum, etc.) provides
//! zero-copy reader methods that access fields directly from the FlatBuffer byte
//! slice via vtable lookups.
//!
//! ## How to regenerate
//!
//! If the upstream `reflection.fbs` schema changes:
//!
//! 1. Build the C++ `flatc` from `original-flatc/`
//! 2. Run: `flatc --rust -o /tmp/ reflection.fbs`
//! 3. Copy the generated file here, replacing this file's contents
//! 4. Re-add this header comment and the `#![allow(...)]` directives below
