...
pub fn base_type_size(bt: BaseType) -> Option<u32> {
    match bt {
        ...
        | BaseType::BASE_TYPE_FLOAT => Some(4),

        BaseType::BASE_TYPE_LONG
        | BaseType::BASE_TYPE_U_LONG
        | BaseType::BASE_TYPE_DOUBLE => Some(8),
...
mod tests {
    ...
    fn test_all_scalar_keywords() {
        ...
        assert_eq!(lookup_base_type("ushort"), Some(BaseType::BASE_TYPE_U_SHORT));
    ...
    fn test_type_aliases() {
        ...
        assert_eq!(lookup_base_type("uint16"), Some(BaseType::BASE_TYPE_U_SHORT));
        ...
        assert_eq!(lookup_base_type("float64"), Some(BaseType::BASE_TYPE_DOUBLE));
    }
